...
- [ ] `desktop/inject-action-board.mjs` refuses non-local `webSocketDebuggerUrl` hosts.
...
- [ ] Extension permissions stay limited to `contextMenus` and `storage`.
- [ ] No remote network permissions are present.
